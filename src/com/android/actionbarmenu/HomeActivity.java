package com.android.actionbarmenu;
...
public class HomeActivity extends ListActivity {
	private static final String[] items = { "Android", "Bluetooth", "Chrome", "Docs", "Email",
			"Facebook", "Google", "Hungary", "Iphone", "Korea", "Machintosh", "Nokia", "Orkut",
			"Picasa", "Singapore", "Talk", "Windows", "Youtube" };
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.about:
			Toast.makeText(this, "Action Bar Menu Example", Toast.LENGTH_LONG).show();
			return (true);
		}
	...
	private void addWord(TextView title) {
		...
		Toast.makeText(HomeActivity.this, title.getText().toString() + " is Entered",
